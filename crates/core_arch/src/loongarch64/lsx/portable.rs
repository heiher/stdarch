...
impl_vv!("lsx", lsx_vclo_b, ls::simd_ctlo, m128i, i8x16);
impl_vv!("lsx", lsx_vclo_h, ls::simd_ctlo, m128i, i16x8);
impl_vv!("lsx", lsx_vclo_w, ls::simd_ctlo, m128i, i32x4);
impl_vv!("lsx", lsx_vclo_d, ls::simd_ctlo, m128i, i64x2);
