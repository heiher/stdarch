...
#[inline(always)]
#[rustc_const_unstable(feature = "stdarch_const_helpers", issue = "none")]
pub(crate) const unsafe fn simd_shuf4i_b<const I: u32, T: Copy>(a: T) -> T {
    simd_shuffle!(
        a,
        a,
        [
...
#[inline(always)]
#[rustc_const_unstable(feature = "stdarch_const_helpers", issue = "none")]
pub(crate) const unsafe fn simd_shuf4i_h<const I: u32, T: Copy>(a: T) -> T {
    simd_shuffle!(
        a,
        a,
        [
...
#[inline(always)]
#[rustc_const_unstable(feature = "stdarch_const_helpers", issue = "none")]
pub(crate) const unsafe fn simd_shuf4i_w<const I: u32, T: Copy>(a: T) -> T {
    simd_shuffle!(
        a,
        a,
        [
...
#[inline(always)]
#[rustc_const_unstable(feature = "stdarch_const_helpers", issue = "none")]
pub(crate) const unsafe fn simd_shuf4i_d<const I: u32, T: Copy>(a: T, b: T) -> T {
    simd_shuffle!(
        a,
        b,
        [
            ((I >> 0) & 3) + ((I >> 0) & 2) + 0, ((I >> 2) & 3) + ((I >> 2) & 2) + 0,
            ((I >> 0) & 3) + ((I >> 0) & 2) + 2, ((I >> 2) & 3) + ((I >> 2) & 2) + 2
        ]
    )
}
...
impl_vvuv!("lasx", lasx_xvshuf4i_d, simd_shuf4i_d, m256i, i64x4, 8, const);
