...
impl_vv!("lasx", lasx_xvclo_b, ls::simd_ctlo, m256i, i8x32);
impl_vv!("lasx", lasx_xvclo_h, ls::simd_ctlo, m256i, i16x16);
impl_vv!("lasx", lasx_xvclo_w, ls::simd_ctlo, m256i, i32x8);
impl_vv!("lasx", lasx_xvclo_d, ls::simd_ctlo, m256i, i64x4);
